...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        setContentsOfTextView(R.id.OutputTextview, b.getStatus());
    }
     ...
     */
	public void computeButtonAddAccount(View view){
	    ...
	    b.addClient(textName, initValue);
	    setContentsOfTextView(R.id.OutputTextview, b.getStatus());
    }

    public void computeButtonConfirm(View view){
	    String type = getItemSelected(R.id.OptionsType);
        String from = getInputOfTextField(R.id.InputFromAccount);
        String to = getInputOfTextField(R.id.InputToAccount);
        String transferAmount = getInputOfTextField(R.id.InputAmount);
