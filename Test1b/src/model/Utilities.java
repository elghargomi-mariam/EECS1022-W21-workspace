...
public class Utilities
{
	...
	public static String getBMIReport(char weightUnit, double w, char heightUnit, double h) {
		...
		if(weightUnit == 'k') {
			if(heightUnit == 'f') {
				bmi = w / ((h * 0.3048)*(h * 0.3048));
				format = String.format("%.2f", bmi);
				if (bmi < 18.5) {
					result ="BMI is: " + format + " (Underweight)";
				}else if (bmi < 25.0 && bmi >= 18.5) {
					result ="BMI is: " + format + " (Normal)";
				}else if (bmi < 30.0 && bmi >=25.0) {
					result = "BMI is: " + format + " (Overweight)";
				}else if (bmi >= 30.0) {
					result = "BMI is: " + format + " (Obese)";
				}
			}else {
			...
			if(heightUnit == 'f') {
				bmi = (w * 0.453592) / ((h * 0.3048)*(h * 0.3048));
				format = String.format("%.2f", bmi);
				if (bmi < 18.5) {
					result ="BMI is: " + format + " (Underweight)";
				}else if (bmi < 25.0 && bmi >= 18.5) {
	...
	public static String getCoffeeTime(char coffeeType, char cupSize, int numberofCup) {
		...
		if (coffeeType == 'L') {
			...
			seconds = prep* numberofCup;
			minutes = seconds / 60 ; 
	        seconds = seconds % 60; 
			if (numberofCup == 1) {
				result = "You ordered 1 cup of type light and size " + size +", then your time is " + minutes + " minutes " + seconds +" seconds" ;
			}else {
				result =  "You ordered " + numberofCup +" cups of type light and size " + size +", then your time is "+ minutes +" minutes " + seconds +" seconds" ;
			}
	        ...
	        seconds = seconds % 60; 
			if (numberofCup == 1) {
				result = "You ordered 1 cup of type regular and size " + size +", then your time is " + minutes + " minutes " + seconds +" seconds" ;
			}else {
				result =  "You ordered " + numberofCup +" cups of type regular and size " + size +", then your time is "+ minutes +" minutes " + seconds +" seconds" ;
			}
	        ...
	        seconds = seconds % 60; 
			if (numberofCup == 1) {
				result = "You ordered 1 cup of type dark and size " + size +", then your time is " + minutes + " minutes " + seconds +" seconds" ;
			}else {
				result =  "You ordered " + numberofCup +" cups of type dark and size " + size +", then your time is "+ minutes +" minutes " + seconds +" seconds" ;
			}
		}
	...
	public static String getTicketValue(int carSpeed, int roadSpeed, char whenItHappen) {
		...
		result = "In the " + when +", your speed was " + diff + " over the limit then your ticket value is " + ticket + "$";
